...
const loginSchema = z.object({
  username: z.string().min(1, "Email is required").min(2, "Please enter a valid username address"),
      ...
      <div className="w-full max-w-md">
        <Card className="shadow-2xl border-0 bg-white/80 backdrop-blur-sm dark:bg-slate-900/80">
          <CardHeader className="space-y-1 pb-6">
            ...
            <CardDescription className="text-center text-slate-600 dark:text-slate-400">Sign in to your account to continue</CardDescription>
          </CardHeader>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input type="text" placeholder="Enter your username" className="h-11" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <div className="relative">
                          <Input type={showPassword ? "text" : "password"} placeholder="Enter your password" className="h-11 pr-10" {...field} />
